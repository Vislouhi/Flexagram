...
public class EncodeAndMuxTest {
    ...
    public EncodeAndMuxTest(){
        outputPath = new File(FlexatarStorageManager.createTmpVideoStorage(), "tmp.mp4").toString();
        mWidth = 360;
        mHeight = 360;
        mBitRate = 1000000;
    }
     ...
     */
    public void testEncodeVideoToMp4(List<float[]> animationPattern) {
        // QVGA at 2Mbps
