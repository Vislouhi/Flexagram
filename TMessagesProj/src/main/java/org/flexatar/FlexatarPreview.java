...
public class FlexatarPreview extends FrameLayout {
    ...
    private final HideEmojiTextView openMouthButton;
    ...
    public FlexatarPreview(@NonNull Context context, File flexatarFile) {
        super(context);
...
//        backgroundProvider.setHasVideo(true);
        openMouthButton = new HideEmojiTextView(context, backgroundProvider);
        openMouthButton.setText("Open Mouth");
        ...
        openMouthButton.setOnClickListener((v) -> {
            ...
            openMouthButton.setText(isMouthOpened ? "Close mouth":"Open mouth");
        });
...
//            }
        ...
        flexatarViewLayoutParameters = new FrameLayout.LayoutParams(-1,-1);
        openMouthButtonLayoutParameters = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.WRAP_CONTENT);
        seekBarLayoutParameters = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.WRAP_CONTENT);
        parameterToEditLayoutParameters = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.WRAP_CONTENT);

        openMouthButton.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
            @Override
...
//                            addView(seekBar, seekBarLayoutParameters);
        ...
        parameterToEditLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
            @Override
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                int width = right - left;
//                int height = bottom - top;
